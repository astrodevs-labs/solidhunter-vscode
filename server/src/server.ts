...
documents.onDidChangeContent(change => {
	connection.console.log("changed document");
});

documents.onDidSave(file => {
	connection.console.log("saved document");
	validateTextDocument(file.document);
});

documents.onDidOpen(file => {
	connection.console.log("opened document");
	validateTextDocument(file.document);
});

async function validateTextDocument(textDocument: TextDocument): Promise<void> {
	connection.console.log("Validating document with uri: '" + textDocument.uri +"' ...");
	...
	const diagnostics: Diagnostic[] = Linter.lintFile(textDocument.uri.replace('file://', ''));
